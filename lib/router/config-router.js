...
function createLocation(locNode) {
  ...
  // Add the headers to whitelist if we have any
  var whitelist_headers = locNode.getValues('whitelist_headers').names;
  if (whitelist_headers){
    settings.whitelist_headers = whitelist_headers;
  }
